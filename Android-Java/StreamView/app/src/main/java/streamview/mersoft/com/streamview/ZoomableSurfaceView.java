...
/**
 * Created by arch (damavandi) on 1/16/17.
 */

public class ZoomableSurfaceView extends org.webrtc.SurfaceViewRenderer {
...
*/
    ...
    private class ScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            //ViewGroup.LayoutParams params = new ViewGroup.LayoutParams((int) (width * scale), (int) (height * scale));
            CoordinatorLayout.LayoutParams params = (CoordinatorLayout.LayoutParams) ZoomableSurfaceView.this.getLayoutParams();
